...
def validate_file(filepath):
    ...
    # Check 2: Must return STEAL or SUPPORT
    returns_valid_move = False
    # Look for return statements with STEAL or SUPPORT constants
    if 'return STEAL' in code or 'return SUPPORT' in code or 'return 0' in code or 'return 1' in code:
        returns_valid_move = True
    
    if not returns_valid_move:
        errors.append("ERROR: No valid return statement found. Must return STEAL or SUPPORT")
